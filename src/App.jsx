  ...
  const handleCompress = async () => {
    ...
    try {
      ...
      if (level === 'high') {
        ...
        // Bolt: Process pages in chunks to speed up compression while avoiding OOM errors
        const CHUNK_SIZE = 3;
        for (let i = 1; i <= pdf.numPages; i += CHUNK_SIZE) {
          ...
          // Sequentially add the rendered images to preserve page order
          for (const { imgBytes, width, height } of renderedPages) {
