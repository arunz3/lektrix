...
const MergePDFTool = () => {
  ...
  const handleMerge = async () => {
    ...
    try {
      ...
      // OPTIMIZATION: Parallelize independent I/O and parsing operations to reduce blocking
      ...
      // Sequentially process results to preserve order
...
const ImageToPDFTool = () => {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      // OPTIMIZATION: Parallelize independent I/O and image embedding operations
      ...
      // Sequentially add pages to preserve order
