  ...
  const handleCompress = async () => {
    ...
    try {
      ...
      if (level === 'high') {
        ...
        const batchSize = 3; // Bolt: Chunk rendering to balance speed and avoid OOM
        ...
        for (let i = 1; i <= totalPages; i += batchSize) {
          ...
          // Embed and draw sequentially to preserve page order
          for (const { imgBytes, width, height } of batchResults) {
