                    ...
                    <div key={i} className="flex flex-col gap-2">
                      <div className="relative aspect-[3/4] bg-white border border-gray-200 rounded-xl overflow-hidden flex items-center justify-center group shadow-sm hover:shadow-md transition-all">
                        ...
                        <div className="absolute inset-0 bg-gray-900/5 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2">
                          <button onClick={() => rotatePage(i, -90)} className="p-2 bg-white shadow-lg rounded-full text-gray-900 hover:text-accent hover:scale-110 transition-all" aria-label="Rotate counter-clockwise"><RotateCcw size={16} /></button>
                          <button onClick={() => rotatePage(i, 90)} className="p-2 bg-white shadow-lg rounded-full text-gray-900 hover:text-accent hover:scale-110 transition-all" aria-label="Rotate clockwise"><RotateCw size={16} /></button>
                        </div>
                      </div>
