...
const MergePDFTool = () => {
  ...
  const handleMerge = async () => {
    ...
    try {
      ...
      // ⚡ Bolt: Parallelize independent I/O and parse tasks before sequentially merging to preserve order
...
const ImageToPDFTool = () => {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      // ⚡ Bolt: Parallelize independent I/O and embedding tasks before sequentially adding to preserve order
