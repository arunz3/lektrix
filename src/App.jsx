...
const MergePDFTool = () => {
  ...
  const handleMerge = async () => {
    ...
    try {
      ...
      // ⚡ Bolt: Parallelize independent I/O and parse tasks to reduce total blocking time
      // We load all array buffers and PDF documents concurrently using Promise.all
      ...
      // Sequentially process the results to preserve page order
...
const ImageToPDFTool = () => {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      // ⚡ Bolt: Parallelize independent I/O and embedding tasks
      // Fetching array buffers and embedding images doesn't need to be strictly sequential
