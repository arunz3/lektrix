              ...
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="grid grid-cols-1 gap-4 p-4 bg-gray-50 dark:bg-slate-900/50 rounded-xl border border-gray-100 dark:border-slate-800">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    <input type="text" maxLength="100" value={metadata.title} onChange={e => setMetadata({...metadata, title: e.target.value})} className="w-full bg-white dark:bg-[#1e293b] border border-gray-200 dark:border-slate-800 rounded-lg px-3 py-2 text-sm focus:ring-1 focus:ring-accent outline-none transition-all" placeholder="e.g. Annual Report" />
                  </div>
                  <div className="space-y-1">
                ...
                <div className="space-y-1">
                  ...
                  <input type="text" maxLength="100" value={metadata.subject} onChange={e => setMetadata({...metadata, subject: e.target.value})} className="w-full bg-white dark:bg-[#1e293b] border border-gray-200 dark:border-slate-800 rounded-lg px-3 py-2 text-sm focus:ring-1 focus:ring-accent outline-none transition-all" placeholder="e.g. Financial Data" />
                </div>
                <div className="space-y-1">
              ...
              <div className="space-y-6 pt-4 border-t border-gray-100 dark:border-slate-800">
                <div className="space-y-4">
                  <div>
                    ...
                    <input type="password" maxLength="50" value={password} onChange={(e) => setPassword(e.target.value)} className="w-full px-4 py-3.5 bg-gray-50 dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-xl outline-none focus:border-accent transition-all dark:text-white" />
                  </div>
                  {mode === 'protect' && (
                    <div>
                      ...
                      <input type="password" maxLength="50" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} className="w-full px-4 py-3.5 bg-gray-50 dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-xl outline-none focus:border-accent transition-all dark:text-white" />
                    </div>
                  )}
                </div>
                {error && <div className="p-4 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 rounded-xl text-sm font-medium border border-red-100 dark:border-red-900/30 flex items-center gap-2"><AlertCircle size={18} /> {error}</div>}
