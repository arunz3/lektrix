...
const FileUpload = ({
  ...
  const handleFiles = (newFiles) => {
    // Bolt: Prevent OOM by slicing before mapping to avoid generating unused object URLs
    const filesArray = Array.from(newFiles);
    const slicedFiles = multiple
      ? filesArray.slice(0, maxFiles !== undefined ? Math.max(0, maxFiles - files.length) : undefined)
