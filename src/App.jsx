...
const MergePDFTool = () => {
  ...
  const handleMerge = async () => {
    ...
    try {
      ...
      // Parallelize file I/O and PDF parsing
      ...
      // Sequentially copy pages to preserve order
...
const ImageToPDFTool = () => {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      // Parallelize file I/O and image embedding
      ...
      // Sequentially add pages to preserve image order
