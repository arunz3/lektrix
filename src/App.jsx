            ...
            <div className="text-center py-8 space-y-4">
              ...
              {!WEB3FORMS_ACCESS_KEY && (
                <div className="text-[11px] bg-amber-500/10 border border-amber-500/20 text-amber-600 dark:text-amber-400 p-3 rounded-xl mx-auto max-w-sm text-left">
                  ⚡ <b>Demo Mode Active:</b> Set <code className="bg-amber-500/20 px-1 rounded font-mono">VITE_WEB3FORMS_ACCESS_KEY</code> in .env with your free key from <a href="https://web3forms.com" target="_blank" rel="noreferrer" className="underline font-bold">web3forms.com</a> to receive live emails!
                </div>
              )}
              <button
                onClick={handleClose}
